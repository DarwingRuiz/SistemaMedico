...
@section('head')
   ...
   <!-- Bootstrap Select Css -->
    {{-- <link href="{{ asset('/Recursos/plugins/bootstrap-select/css/bootstrap-select.css') }}" rel="stylesheet" /> --}}
                            ...
                            <div class="row col-md-12 ">
                             ...
                             <div class="col-md-4">
                               <div class="form-group col-md-4 ">
                                  <select class="form-control show-tick" name="departamento" id="select-departamento">
                                    <option value="0" disable="true" >== Seleccione un Departamento ==</option>
                                    @foreach ($municipio as $mun)
                                        @if ($mun->ID == $atleta->municipio)
                                            @foreach ($departamento as $dep)
                                                @if ($dep->ID == $mun->Departamento_id)
                                                  <option selected="true" value="{{$dep->ID}}">{{ $dep->Nombre }}</option>
                                                @else
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  @foreach ($municipio as $mun)
                                       @if ($atleta->municipio == $mun->ID)
                                          <label id="label_id" disabled for="">Municipio antiguo:{{$mun->Nombre}}</label>
                                       @endif
                                        ...
                                        <select  name="hospitalafiliado" class="form-control p-0">
                                            ...
                                            @if ($atleta->hospital!="1")
                                              @if ($atleta->hospital == $hos->id)
                                                  <option selected value="{{$hos->id}}">{{$hos->Nombre}}</option>
                                              @else
                          ...
                          <fieldset>
                            <div class="row col-md-12">
                              <div class="col-md-6">
                                <div class="form-group form-float">
                                  <div class="form-line">
                                    <input type="text" class="form-control" name="nombremadre" id="nombmadre" value="{{$atleta->nombremadre}}">
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-float">
                                  <div class="form-line">
                                    <input type="text" minlength="8" maxlength="8" class="form-control" name="telmadre" id="telmadre" value="{{$atleta->telmadre}}">
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-float">
                                  <div class="form-line">
                                    <input type="text"  class="form-control" name="nombrepadre" id="nombrepadre" value="{{$atleta->nombrepadre}}">
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-float">
                                  <div class="form-line">
                                    <input type="text" minlength="8" maxlength="8" class="form-control" name="telpadre" id="telpadre" value="{{$atleta->telpadre}}">
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-float">
                                  <div class="form-line">
                                    <input type="text" class="form-control" name="emergencia" id="emergencia" value="{{$atleta->emergencia}}">
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-float">
                                  <div class="form-line">
                                    <input type="text" class="form-control" name="diremergencia" id="diremergencia" value="{{$atleta->emergencia}}">
                                    <label class="form-label">Direccion: </label>
                                  </div>
                                </div>
                              </div>
 ...
 {{--  <script src="../assets/plugins/toast-master/js/jquery.toast.js"></script>
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript">
     ...
     <script type="text/javascript">
     $(function () {
       $('#select-municipio').on('change',visible);
     });
     function visible() {
        $('#label_id').hide();
     }
