							...
							<div class="media-body">
								<div class="personal_text">
									...
									<ul class="list basic_info">
										...
										<li><a href="#"><i class="lnr lnr-phone-handset"></i> {{$atleta->Celular}}</a></li>
										<li><a href="#"><i class="lnr lnr-envelope"></i> businessplan@donald</a></li>
										<li><a href="#"><i class="lnr lnr-home"></i> {{$atleta->Direccion}}</a></li>
									</ul>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <script src="Vista1/js/jquery-3.3.1.min.js"></script>
        <script src="Vista1/s/popper.js"></script>
        <script src="Vista1/js/bootstrap.min.js"></script>
        <script src="Vista1/js/stellar.js"></script>
        <script src="Vista1/vendors/lightbox/simpleLightbox.min.js"></script>
        <script src="Vista1/vendors/nice-select/js/jquery.nice-select.min.js"></script>
        <script src="Vista1/vendors/isotope/imagesloaded.pkgd.min.js"></script>
        <script src="Vista1/vendors/isotope/isotope.pkgd.min.js"></script>
        <script src="Vista1/vendors/owl-carousel/owl.carousel.min.js"></script>
        <script src="Vista1/vendors/popup/jquery.magnific-popup.min.js"></script>
        <script src="Vista1/js/jquery.ajaxchimp.min.js"></script>
        <script src="Vista1/vendors/counter-up/jquery.waypoints.min.js"></script>
        <script src="Vista1/vendors/counter-up/jquery.counterup.min.js"></script>
        <script src="Vista1/js/mail-script.js"></script>
        <script src="Vista1/js/theme.js"></script>
    </body>
</html>Vista1/